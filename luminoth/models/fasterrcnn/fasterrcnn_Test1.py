...
class FasterRCNNNetworkTest(tf.test.TestCase):
    ...
    #     return prediction_dict_perf, prediction_dict_random, config, image_size

    def testCECELoss(self):
        """
        Tests cross entropy, cross entropy classification
        losses of the FasterRCNN (RCNN, RPN layers) and
        ...
        tol = 1e-3
        print("ce ce loss {}".format(loss_random))
    ...
    #     losses of the FasterRCNN (RCNN, RPN layers) respectively and
    #     regression, total losses as well
    #     """
    #     prediction_dict_perf, prediction_dict_random, config, image_size = \
    ...
    #         config, prediction_dict_random, image_size)
    #     loss_random_compare = {
    #         'rcnn_cls_loss': 0.24670556,
    #         'rcnn_reg_loss': 5.030902,
    #         'rpn_cls_loss': 1.249888,
    #         'rpn_reg_loss': 3.7720358,
    #         'no_reg_loss': 13.242992,
    #         'regularization_loss': 0,
    #         'total_loss': 13.242992,
    #     }
    #     tol = 1e-3
    #     print("focal focal loss {}".format(loss_random))
    ...
    #     }
    #     tol = 1e-3
    #     print("focal ce loss {}".format(loss_random))
    ...
    #     }
    #     tol = 1e-3
    #     print("ce focal loss {}".format(loss_random))
