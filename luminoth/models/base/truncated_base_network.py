...
class TruncatedBaseNetwork(BaseNetwork):
    ...
    def __init__(self, config, name="truncated_base_network", **kwargs):
        ...
        self._endpoint = config.endpoint or DEFAULT_ENDPOINTS[config.architecture]
    ...
    def _build(self, inputs, is_training=False):
        ...
        """
        pred = super(TruncatedBaseNetwork, self)._build(inputs, is_training=is_training)
    ...
    def get_trainable_vars(self):
        ...
        scope_var_index_iter = (i for i, name in var_iter if self._endpoint in name)
        index = None
