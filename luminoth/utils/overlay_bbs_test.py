...
class OverlayBbsTest(tf.test.TestCase):
    ...
    def get_test_data(self, image, image_save_path, bboxes, labels, df):
    ...
    def get_ann_filename(self, num_images, columns, all_labels=None):
    ...
    def testAddBasename(self):
        ...
        df = add_base_path(csv, self.input_image_format)
    ...
    def testOverlayBBsOnAllImage(self):
        ...
        num_images = 7
        csv = self.get_ann_filename(num_images, LUMI_CSV_COLUMNS)
